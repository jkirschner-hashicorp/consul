...
- `go test -v ./connect` will run all tests in the connect module (see `./connect` folder)
- `go test -v ./command/agent -run TestRetryJoin` will run all tests in the agent module (see `./command/agent` folder) with name prefix `TestRetryJoin`
